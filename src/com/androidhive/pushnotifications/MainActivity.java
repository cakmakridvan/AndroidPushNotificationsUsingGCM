...
import com.parse.webservis.SplashVideo;
...
//	 SharedPreferences app_preferences_resim_yuklu;
	 
	 //SharedPreferences.Editor editor_resim_yuklu;
	 ...
	 Timer timer_sended;
	 int userInteraction_sended;
	 
	 Timer timer4;
	 int userInteractionTimeout4;

	 Timer timer_deleted;
	 int userInteraction_deleted;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//SharedPrefencesss
		//app_preferences_resim_yuklu = getSharedPreferences("resim_yuklu", MODE_PRIVATE);
		
//		 app_preferences_resim_yuklu = getSharedPreferences("resim_yuklu", context.MODE_WORLD_READABLE);
...
//					startActivity(go_download_pic);
					...
					if(img_size == length_of_image && img_size != 0){
					        ...
					        Toast.makeText(getBaseContext(), "Resim Yüklü", Toast.LENGTH_SHORT).show();
						       ...
						       timer_sended = new Timer();
						       timer_sended.scheduleAtFixedRate(new TimerTask() {

									@Override
									public void run() {
										if (userInteraction_sended == 1) {

											//Connect_send_download_message();
											Connect_downloaded();
											userInteraction_sended = 0;

										}
										userInteraction_sended++;
									}
								}, 0, 1000);
...
//					        editor_resim_yuklu = app_preferences_resim_yuklu.edit();
//					        editor_resim_yuklu.putString("resim", "Resim_Yuklu"); 
//					        editor_resim_yuklu.commit();
//					        
//							Intent launchIntentm = getPackageManager().getLaunchIntentForPackage("com.example.androidhive");
...
//							userInteractionTimeout = 0;
//						
//							startActivity(launchIntentm);

					       
//		Intent refresh = new Intent(MainActivity.this,ResimYuklu.class);
//		refresh.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP);
...
//		startActivity(refresh);
				...
				/*	       
					   ...
					   */    
				        ...
				        //editor_resim_yuklu = app_preferences_resim_yuklu.edit();
				        //editor_resim_yuklu.putString("resim", "Resim"); 
				        //editor_resim_yuklu.commit();
...
//		finish();
			...
			else if(newMessage.equals("FRONTSHOW")){
				
				
				Intent send_show_splash = new Intent(MainActivity.this, SplashVideo.class);
				send_show_splash.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				
/*						send_show
				.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP
						);*/
				
				send_show_splash.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
				timer_send.cancel();
		        userInteractionTimeout = 0;
		        startActivity(send_show_splash);
				...
				if(deleted == true){
					...
					Toast.makeText(getApplicationContext(), "Resim Dosyası silindi", Toast.LENGTH_SHORT).show();
				       ...
				       timer_deleted = new Timer();
				       timer_deleted.scheduleAtFixedRate(new TimerTask() {

							@Override
							public void run() {
								if (userInteraction_deleted == 1) {

									//Connect_send_download_message();
									Connect_deleted_message();
									userInteraction_deleted = 0;

								}
								userInteraction_deleted++;
							}
						}, 0, 1000);
...
//				android.os.Process.killProcess(android.os.Process.myPid());
			...
			else if(newMessage.equals("Ping")){
...
/*			     // Refresh main activity upon close of dialog box
				...
				refresh.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
				startActivity(refresh);
//				Toast.makeText(getApplicationContext(), "Ping Tamam", Toast.LENGTH_SHORT).show();
...
//			dialog.show();
	...
	private void Connect_send_data_work() {
		...
		try {
			...
			jsonparameter.put("Par2", "iph_2.3");
...
//		userInteractionTimeout = 0;
	...
	private void Connect_send_data_workkk() {
		// TODO Auto-generated method stub
...
//            Toast.makeText(MainActivity.this, "Two Finger Double Tap", Toast.LENGTH_SHORT).show();
	...
	private void Connect_downloaded() {
		// TODO Auto-generated method stub
...
//                String al = get_result;
	...
	private void Connect_deleted_message() {
		// TODO Auto-generated method stub
		...
		try {
			...
			jsonparameter.put("Imei", device_id);
			jsonparameter.put("MSG", "CLIENT_DELETE_IMG");
			jsonparameter.put("Par1", "iph_2.3");
			jsonparameter.put("Par2", get_name);
