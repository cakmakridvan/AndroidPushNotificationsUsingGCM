...
import com.androidhive.pushnotifications.GCMIntentService;
...
public class ShowFile extends Activity {
	...
	SharedPreferences prefs_get_resim;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
		    Uri notificationm = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
		    Ringtone r = RingtoneManager.getRingtone(getApplicationContext(), notificationm);
		    r.play();
		} catch (Exception e) {
		    e.printStackTrace();
		}
		...
		//SharedPrefencesss_resim
		//prefs_get_resim = getSharedPreferences("resim_yuklu",MODE_PRIVATE); 
...
//                String al = get_result;
	...
	private void Connect_send_data_work() {
		...
		try {
			...
			jsonparameter.put("Par2", "iph_2.1");
